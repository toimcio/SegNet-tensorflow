...
def Test():
    batch_size = 1
    train_dir = "/zhome/1c/2/114196/Documents/SegNet-tensorflow/segnet_vgg_bayes_30000/model.ckpt-30000"
    ...
    with tf.Graph().as_default():
        ...
        #The queue runners basic reference: https://www.tensorflow.org/versions/r0.12/how_tos/threading_and_queues
            ...
            for step in range(max_steps):
                ...
                if step == (max_steps-1):
                    np.save("/zhome/1c/2/114196/Documents/SegNet-tensorflow/segnet_vgg_bayes_30000/Data/trainloss",train_loss)
                    np.save("/zhome/1c/2/114196/Documents/SegNet-tensorflow/segnet_vgg_bayes_30000/Data/trainacc", train_accuracy)
                    np.save("/zhome/1c/2/114196/Documents/SegNet-tensorflow/segnet_vgg_bayes_30000/Data/valloss", val_loss)
                    np.save("/zhome/1c/2/114196/Documents/SegNet-tensorflow/segnet_vgg_bayes_30000/Data/valacc", val_acc)
